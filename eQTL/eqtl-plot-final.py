...
motor_intersect_rand_spinal_ID = pd.read_table("C://Users//libin//UCSF//eQTL/motor/motor_intersect_rand_spinal_merged.ID", sep="\t", names=["interactions_ID"])
...
motor_final_plot = motor_final_plot[["motor","random", "non-signif","liver", "blood"]]

plt.figure()
sns.boxplot(x="variable",y="value",data=motor_final_plot.melt(), palette="Pastel2").set(ylim=(3,20))
plt.savefig('C://Users//libin//UCSF/eQTL/motor_final.pdf', transparent=True)

plt.figure()
sns.boxplot(x="variable",y="value",data=motor_final_plot.melt(), palette="Pastel2", showfliers=False).set(ylim=(3,20))
plt.savefig('C://Users//libin//UCSF/eQTL/motor_final_Foutlier.pdf', transparent=True)
